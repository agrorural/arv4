  ...
  if (!isset($display)) {
    $conditionalCheck = new ConditionalTagCheck(
      ...
      [
        'is_404',
        'is_front_page',
        ['is_page', ['sala-de-prensa', 'redes-sociales', 'servicios-en-linea', 'gobierno-abierto', 'portal-de-transparencia-estandar', 'consulta-de-documentos', 'acceso-a-la-informacion','codigo-de-etica-de-la-funcion-publica', 'quejas-denuncias-y-reclamos','biblioteca-virtual']],
