...
<li><a href="<?php echo $dir.'/transparencia/convocatorias/formatos';?>/a1-<?php echo $post__date; ?>.pdf" target="_blank"><i class="fa-li fa fa-check-square"></i>Anexo Nº 1</a></li>
<li><a href="<?php echo $dir.'/transparencia/convocatorias/formatos';?>/a7-<?php echo $post__date; ?>.pdf" target="_blank"><i class="fa-li fa fa-check-square"></i>Anexo Nº 7</a></li>
<li><a href="<?php echo $dir.'/transparencia/convocatorias/formatos';?>/a8-<?php echo $post__date; ?>.pdf" target="_blank"><i class="fa-li fa fa-check-square"></i>Anexo Nº 8</a></li>
</ul>'>Formatos</a>
		        		<?php } else { ?>
