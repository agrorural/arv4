...
<form role="search" method="get" class="searchform_for_<?php echo $query_types_value; ?>" id="searchform" action="<?php echo home_url( '/' ); ?>">
	...
	<div class="checkbox">
		...
		<label class="cb__producto" for="cb__producto"><input id="cb__producto" type="checkbox" name="post_type[]" value="producto" <?php if (in_array('producto', $query_types, false) || is_post_type_archive('producto') || is_page_template('archive-producto.php')) { echo 'checked'; } ?> /> Productos</label>
