	...
	<div class="wrap container" role="document">
		<div class="content row">
			...
			<aside class="sidebar eventos">
				<p><a href="<?php echo bloginfo('url'); ?>/decreto-de-urgencia-002-2018/"><img src="<?php echo bloginfo('url'); ?>/wp-content/uploads/2018/02/la_peruanisima__banner-2.jpg" alt="" class="img-responsive"></a></p>
